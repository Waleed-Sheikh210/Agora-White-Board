...
class MyWhiteBoard extends StatefulWidget {
  const MyWhiteBoard({Key? key}) : super(key: key);

  @override
  State<MyWhiteBoard> createState() => _MyWhiteBoardState();
}
...
class _MyWhiteBoardState extends State<MyWhiteBoard> {
  Future<WhiteRoom> _joinRoomAgain() async {
    return await whiteSdk!.joinRoom(
        options: RoomOptions(
          uuid: "d4184790ffd511ebb9ebbf7a8f1d77bd",
          roomToken: "NETLESSROOM_YWs9eTBJOWsxeC1IVVo4VGh0NyZub25jZT0xNjI5MjU3OTQyNTM2MDAmcm9sZT0wJnNpZz1lZDdjOGJiY2M4YzVjZjQ5NDU5NmIzZGJiYzQzNDczNDJmN2NjYTAxMThlMTMyOWVlZGRmMjljNjE1NzQ5ZWFkJnV1aWQ9ZDQxODQ3OTBmZmQ1MTFlYmI5ZWJiZjdhOGYxZDc3YmQ",
          uid: "123456",
          isWritable: true,
        ));
  }
      ...
      children: [
        WhiteboardView(
          ...
          onSdkCreated: (whiteSdk) async {
            var room =await whiteSdk.joinRoom(
                options: RoomOptions(
                    uuid: "d4184790ffd511ebb9ebbf7a8f1d77bd",
                    roomToken:
        ...
        Container(
          child: whiteRoom != null
            ...
            room: whiteRoom!,
            onReconnect: ()async{
              var replay = await whiteSdk!.joinReplay(options: ReplayOptions(
                room: "d4184790ffd511ebb9ebbf7a8f1d77bd",
                roomToken:  "NETLESSROOM_YWs9eTBJOWsxeC1IVVo4VGh0NyZub25jZT0xNjI5MjU3OTQyNTM2MDAmcm9sZT0wJnNpZz1lZDdjOGJiY2M4YzVjZjQ5NDU5NmIzZGJiYzQzNDczNDJmN2NjYTAxMThlMTMyOWVlZGRmMjljNjE1NzQ5ZWFkJnV1aWQ9ZDQxODQ3OTBmZmQ1MTFlYmI5ZWJiZjdhOGYxZDc3YmQ",
              ));
            },
          )
  ...
  OperatingViewState() {
    allOpList = [
      ...
      OpListItem("Insert Image", Category.Image, () {
        var image =
        ImageInformation(centerX: 0, centerY: 0, width: 200, height: 200);
